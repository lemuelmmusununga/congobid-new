{{-- <a class="btn btn-primary" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">
  ...
  <div wire:ignore.self class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" style="width: 100%;">
    ...
    <div class="content-block">
        ...
        <div class="content-bid">
            <div class="container">
                ...
                <div class="text-center">
                    <button class="btn btn-achat-bid">
                        Valider
                    </button>
                </div>
            </div>
