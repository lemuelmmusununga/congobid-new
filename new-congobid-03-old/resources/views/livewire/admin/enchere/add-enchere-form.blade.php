<div>
    <form action="{{ route('encheres.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="cout_livraison" class="form-control " id="smallInput"
                                placeholder="Entrez son coût de livraison" value="0">
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="participant" class="form-control " id="smallInput"
                                placeholder="Entrez le nombre de participant" required>
                        </div>
                        {{-- <div class="form-group">
                            ...
                            <input type="number" name="credit_enchere_auto" class="form-control " id="smallInput"
                                placeholder="Entrez son crédit d'enchère automatique" value="0">
                        </div> --}}
                        <div class="form-group">
