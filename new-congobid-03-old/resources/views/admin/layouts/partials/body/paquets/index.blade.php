        ...
        <div class="page-inner py-2">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                ...
                <div class="ml-md-auto py-2 py-md-0">
                    <a href="{{ route('paquets.create') }}" class="btn btn-white btn-border btn-round mr-2">Ajouter une
                        catégorie</a>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-4 pl-md-0">
                    <div class="card card-pricing" style="border-radius: 24px;">
                        ...
                        <div class="card-body">
                            <ul class="specification-list">
                                <li>
                                    ...
                                    <span
                                        class="status-specification">{{ $paquet->nombreEnchere() }}/{{ $paquet->nombre_enchere }}</span>
                                </li>
                                <li>
                                    <span class="name-specification">Nombre de membres</span>
                                    <span
                                        class="status-specification">{{ $paquet->bideurs == null ? 0 : $paquet->bideurs->count() }}</span>
                                </li>
                                <li>
                        ...
                        <div class="card-footer">
                            <a href="{{ route('paquets.edit', [$paquet->id]) }}" class="btn btn-primary btn-block"
