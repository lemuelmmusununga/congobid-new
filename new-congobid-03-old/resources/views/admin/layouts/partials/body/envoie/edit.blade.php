    ...
    <div class="panel-header bg-primary-gradient">
        <div class="page-inner py-2">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                ...
                <div>
                    <h2 class="text-white pb-2 fw-bold">Modifier Envoie de bids</h2>
                </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 my-5">
                <form action="{{ route('envoie.update') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="envoie_id" value="{{$envoie->id}}"   >
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="user_id" id="user_id" class="form-control">
                                            ...
                                            @foreach ($users as $user)
                                                <option value="{{ $user->id }}" {{$user->id == $envoie->user_id ? 'selected':''}}>
                                                    {{ $user->username }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="bid_statut_id" id="bid_statut_id" class="form-control">
                                            @foreach ($bidstatuts as $statut)
                                                <option value="{{ $statut->id }}"{{$statut->id == $envoie->bid_statut_id ? 'selected':''}}>
                                                    {{ $statut->libelle }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-3 col-lg-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number " name="number" class="form-control " id="smallInput"
                                            placeholder="Entrez le nombre des bids " required value="{{$envoie->number}}">
                                    </div>
                                </div>
