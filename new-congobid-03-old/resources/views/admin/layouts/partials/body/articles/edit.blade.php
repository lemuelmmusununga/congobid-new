                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" value="{{ $article->date_debut }}" name="debut_enchere" class="form-control "
                                            id="smallInput">
                                    </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $article->enchere->munite .' : '. $article->enchere->seconde}} " name="fin_enchere" class="form-control "
                                            id="smallInput">
                                    </div>
                                    <div class="form-group">
