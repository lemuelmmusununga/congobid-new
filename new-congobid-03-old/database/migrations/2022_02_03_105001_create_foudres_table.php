...
class CreateFoudresTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('foudres', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('bideur_id')->constrained()->onDelete('cascade')->onUpdate('cascade');
