                                ...
                                <div class="col-lg-4 ">
                                    <form method="POST" action="{{ route('update.profile') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row g-3">
                                            ...
                                            <div class="col-12">
                                                <div class="col-password">
                                                    <x-input  id="password" class="block form-control rounded-pill mt-1 w-full" type="password" name="password" placeholder="Taper a nouveau le nouveau mot de passe"  autocomplete="new-password"  />
                                                </div>
                                            </div>
                                            <div class="col-12">
                ...
                @if ((Auth::user()->avatar == "default.png") || (Auth::user()->avatar == "default.jpg") || (Auth::user()->avatar == "users/default.png") || (Auth::user()->avatar == "") || (Auth::user()->avatar == null))
                    <div class="avatar-profil">
                        ...
                        <div class="upload-file">
                            ...
                            <input type="file" id="img-file" accept=".jpg, .png, .svg, .jpeg">
                        </div>
                    </div>
                @else
                    <div class="avatar-profil">
                        ...
                        <div class="upload-file">
                            ...
                            <input type="file" id="img-file" accept=".jpg, .png, .svg, .jpeg" value="img-file">
                        </div>
                    </div>
                @endif
            </div>
