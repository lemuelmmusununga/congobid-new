...
<div class="page-inner mt--5">
    <div class="row mt--2">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
                        <div class="px-2 pb-2 pb-md-0 text-center">
                            ...
                            <h6 class="fw-bold mt-3 mb-0">Transactions récentes</h6>
                        </div>
                        <div class="px-2 pb-2 pb-md-0 text-center">
                            <div id="circles-2"></div>
                            <h6 class="fw-bold mt-3 mb-0">Nouveaux clients</h6>
                        </div>
                        <div class="px-2 pb-2 pb-md-0 text-center">
                            <div id="circles-3"></div>
                            <h6 class="fw-bold mt-3 mb-0">Enchères remportées</h6>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-6">
            <div class="card full-height">
                <div class="card-body">
                    <div class="card-title">Ventes totales hebdomadaires</div>
                    <div class="row py-3">
                        <div class="col-md-4 d-flex flex-column justify-content-around">
                            <div>
                                <h6 class="fw-bold text-uppercase text-success op-8">Montant total</h6>
                                <h3 class="fw-bold">$9.782</h3>
                            </div>
                            <div>
                                <h6 class="fw-bold text-uppercase text-danger op-8">Nombre d'enchères</h6>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card card-primary">
                <div class="card-header">
                    <div class="card-title">Meilleure vente de l'année</div>
                    <div class="card-category">Samedi, 01 Janvier 2022</div>
                </div>
                                ...
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="{{ asset('admins/img/flags/us.png') }}"
                                                        alt="united states">
                                                </div>
                                            </td>
                                            <td>USA</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="{{ asset('admins/img/flags/au.png') }}" alt="australia">
                                                </div>
                                            </td>
                                            <td>Australia</td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="{{ asset('admins/img/flags/ru.png') }}" alt="russia">
                                                </div>
                                            </td>
                                            <td>Russia</td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="{{ asset('admins/img/flags/cn.png') }}" alt="china">
                                                </div>
                                            </td>
                                            <td>China</td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="flag">
                                                    <img src="{{ asset('admins/img/flags/br.png') }}" alt="brazil">
                                                </div>
                                            </td>
                                            <td>Brasil</td>
                                            <td class="text-right">
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body pb-0">
                    <div class="d-flex">
                        <div class="avatar">
                            <img src="{{ asset('admins/img/logoproduct.svg') }}" alt="..."
                    ...
                    <div class="d-flex">
                        <div class="avatar">
                            <img src="{{ asset('admins/img/logoproduct3.svg') }}" alt="..."
                                class="avatar-img rounded-circle">
                        </div>
                        <div class="flex-1 pt-1 ml-2">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="card-list">
                        ...
                        <div class="item-list">
                            <div class="avatar">
                                <img src="{{ asset('admins/img/chadengle.jpg') }}" alt="..."
                                    class="avatar-img rounded-circle">
                            </div>
                            <div class="info-user ml-3">
                        ...
                        <div class="item-list">
                            <div class="avatar">
                                <img src="{{ asset('admins/img/talha.jpg') }}" alt="..."
                                    class="avatar-img rounded-circle">
                            </div>
                            <div class="info-user ml-3">
                        ...
                        <div class="item-list">
                            <div class="avatar">
                                <img src="{{ asset('admins/img/mlane.jpg') }}" alt="..."
                                    class="avatar-img rounded-circle">
                            </div>
                            <div class="info-user ml-3">
