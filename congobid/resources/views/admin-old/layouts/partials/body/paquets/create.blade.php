                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="nombre_enchere" class="form-control form-control-sm"
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="duree" class="form-control form-control-sm" id="smallInput"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="min" class="form-control form-control-sm" id="smallInput"
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="max" class="form-control form-control-sm" id="smallInput"
