@section('body')
    ...
    <!-- Pricing -->
    <div class="row justify-content-center align-items-center mb-10">
                ...
                <div class="col-md-3 pl-md-0">
                    <div class="card card-pricing">
                        ...
                        <div class="card-footer">
                            <a href="{{ route('paquets.edit', [$paquet->id]) }}" class="btn btn-primary btn-block">Editer</a>
                            ...
                            @elseif ($paquet->statut->id == 2)
                                <a href="{{ route('paquets.destroy', [$paquet->id, 2]) }}" class="btn btn-warning btn-block">Réactiver</a>
