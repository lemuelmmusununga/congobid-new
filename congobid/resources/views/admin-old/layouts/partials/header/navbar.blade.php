        ...
        <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                                    ...
                                    <a href="#">
                                        <div class="notif-img">
                                            {{-- @if ((Auth::user()->avatar == "default.png") || (Auth::user()->avatar == "default.jpg") || (Auth::user()->avatar == "users/default.png") || (Auth::user()->avatar == "") || (Auth::user()->avatar == null))
                                                JM
                                            @else --}}
                                                <img src="{{ asset('images/users/'.$chat->user->avatar) }}" alt="Profil de {{ $chat->user->nom }}">
                                            {{-- @endif --}}
                                        </div>
                                        <div class="notif-content">
                                        <span class="subject">{{ $chat->user->nom }}</span>
                                            <span class="block">{{ $chat->libelle }}</span>
                    ...
                    <li>
                        <div class="notif-scroll scrollbar-outer">
                            <div class="notif-center">
                                ...
                                <a href="#">
                                    <div class="notif-img">
                                        <img src="{{ asset('admins/img/profile2.jpg') }}" alt="Img Profile">
                                    </div>
                                    <div class="notif-content">
                                        <span class="block">
            ...
            <li class="nav-item dropdown hidden-caret">
                <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
                    <div class="avatar-sm">
                        <img src="{{ asset('images/profil/' . Auth::user()->avatar) }}" alt="..."
                        ...
                        <li>
                            <div class="user-box">
                                <div class="avatar-lg"><img
                                        src="{{ asset('images/profil/' . Auth::user()->avatar) }}"
