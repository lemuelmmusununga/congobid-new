                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="bid_id" class="form-control form-control-sm" id="smallInput" placeholder="Entrez le nombre de bid" required value="{{ $bid->id }}">
                                    <input type="text" name="quantite" class="form-control form-control-sm" id="smallInput" placeholder="Entrez le nombre de bid" required value="{{ $bid->quantite }}">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group">
                                    <label for="smallInput">Valeur en $</label>
                                    <input type="text" name="valeur" class="form-control form-control-sm" id="smallInput" placeholder="Entrez son équivalence en $" required value="{{ $bid->valeur }}">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group">
